...
# sorting height, creating a rank variable
bodyData.sort_values(by='height', ascending=False, inplace=True)
bodyData['rankHeight'] = np.arange(1,253)

# sorting weight, creating a rank variable
bodyData.sort_values(by='weight', ascending=False, inplace=True)
bodyData['rankWeight'] = np.arange(1,253)
